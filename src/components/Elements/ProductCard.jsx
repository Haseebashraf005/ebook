...
export const ProductCard = ({ item }) => {
  const { id, name, poster, overview, best_seller } = item
  // console.log(name)
  return (
    <div className="m-3 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">


      <Link to={`product-details/${id}`} className="relative" >
        {
          best_seller &&
          <span className="absolute top-4 left-2 px-2 bg-orange-500 bg-opacity-90 text-white rounded">Best Seller</span>
        }
        {/* <img className="rounded-t-lg w-full h-64" src="./images/10001.avif" alt="" /> */}
